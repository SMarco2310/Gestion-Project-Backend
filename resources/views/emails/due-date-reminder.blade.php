...
<!-- Converted from your uploaded HTML: {{var}} placeholders -> Blade {{ $var }} -->
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f7f7f5; border-radius:6px; border-left:4px solid #EF9F27;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 4px 0; font-size:12px; font-weight:bold; color:#854F0B; text-transform:uppercase; font-family:Arial, Helvetica, sans-serif;">
                      {{ $projectName }}
                    </p>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding-right:8px;">
                          <table role="presentation" cellpadding="0" cellspacing="0">
                            <tr>
                              <td style="background-color:#f7c1c1; border-radius:4px; padding:4px 10px; font-size:12px; font-weight:bold; color:#791F1F; font-family:Arial, Helvetica, sans-serif;">
                                Priorité : {{ $priority }}
                              </td>
                            </tr>
                          </table>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#378ADD; border-radius:6px;">
                    <a href="{{ $taskUrl }}" target="_blank" style="display:inline-block; padding:14px 32px; font-size:15px; font-weight:bold; color:#ffffff; text-decoration:none; font-family:Arial, Helvetica, sans-serif;">
                      Voir la tâche
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:40px 32px 32px 32px;" align="center">
              <p style="margin:0; font-size:12px; color:#888780; font-family:Arial, Helvetica, sans-serif;">
                Vous recevez ce rappel car cette tâche vous est assignée sur [App Name].<br>
